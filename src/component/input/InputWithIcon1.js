    ...
    return (
        ...
        <View style={[styles.inputBox, inputStyle, { borderColor: focusColor }]}>
            {/* <Icons
                name={leftIcon}
                size={20}
                color={focusColor == COLORS.primary ? COLORS.primary : COLORS.placeholderColor}
                style={styles.icon}
            /> */}
            <TextInput
            ...
            <TouchableOpacity
                ...
                <Icons
                    name={rightIcon}
                    size={20}
                    color={focusColor == COLORS.primary ? COLORS.primary : rightIconclr || COLORS.white}
                  //color={focusColor == COLORS.primary ? COLORS.primary : rightIconclr || COLORS.placeholderColor}
